 ...
 */
export async function mediaId(data, contentType) {
...
export function mediaContentType(id) {
    const extension = id.slice(id.lastIndexOf('.') + 1);
    const encontrado = Object.entries(WIWO_MEDIA_TYPES).find(([, propia]) => propia === extension);
