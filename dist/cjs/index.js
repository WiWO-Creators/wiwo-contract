...
exports.validateAgainstFields = exports.parseArticleDraft = exports.WRITE_AUTH_SCHEME = exports.CORE_FIELD_KEYS = exports.proposeId = exports.buildArticleDraft = exports.parseMarkdownBlocks = exports.WIWO_COMMON_BLOCK_TYPES = exports.WIWO_MEDIA_TYPES = exports.WIWO_MEDIA_MAX_BYTES = exports.sliceByCursor = exports.resolvePageSize = exports.encodeCursor = exports.decodeCursor = exports.MAX_PAGE_SIZE = exports.DEFAULT_PAGE_SIZE = exports.publicOrigin = exports.jsonResponse = exports.isIsoDate = exports.errorResponse = exports.CONTRACT_PATH = exports.describeManifestProblem = exports.parseManifest = exports.parseArticlePage = exports.audienceOf = exports.isSupportedContract = exports.SUPPORTED_CONTRACTS = exports.WIWO_CONTRACT_VERSION = void 0;
...
Object.defineProperty(exports, "audienceOf", { enumerable: true, get: function () { return contract_js_1.audienceOf; } });
