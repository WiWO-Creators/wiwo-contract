 ...
 * lo correcto.
 */
export declare const WIWO_CONTRACT_VERSION = "1.2";
/**
 ...
 * leer a los dos.
 */
export declare const SUPPORTED_CONTRACTS: readonly ["1.0", "1.1", "1.2"];
export type SupportedContract = (typeof SUPPORTED_CONTRACTS)[number];
/** True si un lector de este paquete sabe leer esa versión. */
export declare function isSupportedContract(contract: string): boolean;
/**
 ...
 */
export type WiwoFieldType = 'text' | 'longtext' | 'markdown' | 'blocks' | 'enum' | 'image' | 'tags' | 'list' | 'pairs' | 'number' | 'boolean';
 ...
 */
export declare function audienceOf(manifest: WiwoManifest): WiwoAudience;
